...
#para caso frecuentista usar solo neg_log_likelihood
...
with tf.compat.v1.Session() as sess:
  ...
  #para caso frecuentista usar este fragmento para la media y cambiar el nombre, si se usa Dense en vez de DenseFlipoutn usar layer.kernel en vez de layer.kernel_posterior.mean()
  ...
  visualize_decision(x, y, (w_true, b_true),
                     ...
                     fname=os.path.join(r"SRC/Sinteticos/Figuras",
