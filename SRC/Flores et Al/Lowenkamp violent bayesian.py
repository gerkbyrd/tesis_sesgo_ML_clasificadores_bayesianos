# -*- coding: utf-8 -*-
"""
Created on Fri Jun 26 09:35:34 2020
...
#logreg_input_matrix0nf = np.ones((logreg_input_matrix_nf_1.shape[0],1))
#logreg_input_matrix = logreg_input_matrix0

"""
logreg_input_matrix = logreg_input_matrix2
logreg_input_matrix = logreg_input_matrix3
...
ax.set_title('Coeficientes, sus distribuciones a posteriori, y la distribución común a priori (reincidencia violenta, datos sin filtrar)')
...
#ax.set_title('Probabilidad promedio estimada de reincidencia general por raza (reincidencia violenta, datos filtrados)')
